...
<div class="figure">
<img src="figure/autoplot-1.png" alt="Rainbow plot of mortality rates in Norway." width="100%" />
<p class="caption">Rainbow plot of mortality rates in Norway.</p>
</div>
...
<div class="figure">
<img src="figure/pyramid-1.png" alt="Population pyramids for Norway." width="100%" />
<p class="caption">Population pyramids for Norway.</p>
</div>
...
<div class="figure">
<img src="figure/e0-1.png" alt="Life expectancy at birth in Norway." width="100%" />
<p class="caption">Life expectancy at birth in Norway.</p>
</div>
...
<div class="figure">
<img src="figure/smoothing-1.png" alt="Smoothed mortality rates in Norway for 1967." width="100%" />
<p class="caption">Smoothed mortality rates in Norway for 1967.</p>
</div>
...
<div class="figure">
<img src="figure/lc3-1.png" alt="Components from Lee-Carter model." width="100%" />
<p class="caption">Components from Lee-Carter model.</p>
</div>
...
<div class="figure">
<img src="figure/fdm-1.png" alt="First few components from functional data model for mortality in Norway." width="100%" />
<p class="caption">First few components from functional data model for mortality in Norway.</p>
</div>
...
<div class="figure">
<img src="figure/fdmplot-1.png" alt="First three components from functional data model for mortality in Norway." width="100%" />
<p class="caption">First three components from functional data model for mortality in Norway.</p>
</div>
