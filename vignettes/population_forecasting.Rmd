...
We can also plot population pyramids with prediction intervals. Here is the population pyramid for 2032 with a 95% prediction interval.
...
pyramid_2032 |>
  ggplot(aes(x = Age)) +
  geom_ribbon(aes(ymin = lo, ymax = hi, colour = NULL), fill = "#c14b14", alpha=0.2) +
